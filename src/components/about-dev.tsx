    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-4 pb-2 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          <h2 id="modal-title" className="text-2xl font-bold text-gray-800 dark:text-gray-100">About The Developer</h2>
          <button
            onClick={onClose}
    ...
    <>
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
        ...
        <div className="text-gray-700 dark:text-gray-300 space-y-4">
          <p>
            This app was developed by <a href="https://devmahmoud-portfolio.vercel.app" className='font-bold text-blue-500'>Dev Mahmoud</a>, an aspiring AI Engineer passionate about 
            creating inclusive technologies that enhance learning and accessibility for all.
          </p>
            <p>
                <a href="https://devmahmoud-portfolio.vercel.app" className='px-5 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-70 transition-colors duration-200'>
